...
csv_file = '/afs/tu-chemnitz.de/home/urz/a/abom/data/df_limit_large_clean.csv'
...
torch.save(autoencoder.state_dict(), f'{autoencoder._get_name()}_{seq_len}_shuffled_{embed_size}.pt')
